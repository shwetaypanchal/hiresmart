<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="AdonisWebsite.Registration" %>
...
<html lang="en">
  ...
  <section class="ftco-section bg-light">
      ...
      <div class="container" style="padding-left:25px;">
          ...
          <div class="row">
          <div class="col-md-2 col-xs-12">Product : </div>
          <div class="col-md-4 col-xs-12"><asp:DropDownList ID="ddlProduct" AutoPostBack="true" runat="server"  OnSelectedIndexChanged="ddlProduct_SelectedIndexChanged">
             
              </asp:DropDownList>
              <asp:RequiredFieldValidator ID="rfvProduct" runat="server" ControlToValidate="ddlProduct"
                ErrorMessage="Value Required!" ForeColor="Red" InitialValue="--SELECT--"></asp:RequiredFieldValidator>
          </div>
          <div class="col-md-2 col-xs-12">&nbsp; Model: </div>
          ...
          <div class="row">
          <div class="col-md-2 col-xs-12">&nbsp; Date of purchase</div>
          <div class="col-md-2 col-xs-12"><asp:TextBox ID="txtdop" runat="server" TextMode="Date" /> </div>
              <div class="col-md-2 col-xs-12">Warranty : </div>
              <div class="col-md-2 col-xs-12">
                  <asp:DropDownList ID="ddlwarranty" runat="server">
                      <asp:ListItem Value="0">--SELECT--</asp:ListItem>
                      <asp:ListItem Value="61">InWarranty</asp:ListItem>
                      <asp:ListItem Value="62">OutWarranty</asp:ListItem>
                  </asp:DropDownList>
              </div>
          <div class="col-md-2 col-xs-12">&nbsp; Standard Problem</div>
          <div class="col-md-2 col-xs-12">
          ...
          <div class="row">
          <div class="col-md-3">Detail About Complaint : </div>
          <div class="col-md-9"><asp:TextBox ID="txtdetail" runat="server" TextMode="MultiLine" Width="500" />
              <asp:RequiredFieldValidator ID="rfvDetail" runat="server" ControlToValidate="txtdetail" ForeColor="Red" Text="State your complaint" />
          </div>
         </div>
          <br />
          <div class="row">

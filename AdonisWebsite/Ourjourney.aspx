<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ourjourney.aspx.cs" Inherits="AdonisWebsite.Ourjourney" %>
...
<html lang="en">
    ...
    <section class="hero-wrap hero-wrap-abt" style="background-color:white;">
      ...
      <div class="container">
          ...
          <div class="col-md-9 ftco-animate">
            <br />
            <p class="breadcrumbs"><span class="mr-2"><a href="Home.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Our Journey <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
  ...
  <section class="ftco-section bg-light">
      ...
      <div class="container">
          ...
          <img src="/images/chart2.jpg" class="img-1" />
